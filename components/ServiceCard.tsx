...
const ServiceCard = ({
  ...
  return (
    <div className="flex flex-1 justify-center items-center flex-col gap-8 p-8 text-center rounded-lg min-w-[15rem]  cursor-pointer hover:text-purple-600 shadow-xl shadow-[#666]">

...
const SubHeader = () => {
  ...
  return (
    <nav
      className={`fixed left-0 top-0 z-50 hidden h-[4vh] w-full items-center justify-around border-b border-b-white bg-black px-6 py-4 text-xs md:text-sm lg:flex`}
